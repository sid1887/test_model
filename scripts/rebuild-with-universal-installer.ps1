...
docker compose -f docker-compose.yml -f docker-compose.universal.yml build --no-cache
...
docker compose -f docker-compose.yml -f docker-compose.universal.yml up -d
